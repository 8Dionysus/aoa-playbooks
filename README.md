...
- checkpoint distillation and closed-loop pilot: [docs/CHECKPOINT_DISTILLATION_CLOSED_LOOP_PILOT](docs/CHECKPOINT_DISTILLATION_CLOSED_LOOP_PILOT.md)
- Titan live session drill and route ecology: [docs/TITAN_LIVE_SESSION_DRILL_ROUTE](docs/TITAN_LIVE_SESSION_DRILL_ROUTE.md) and [docs/TITAN_ROUTE_ECOLOGY_PLAYBOOK](docs/TITAN_ROUTE_ECOLOGY_PLAYBOOK.md)
...
- Titan live drill route and route ecology: `docs/TITAN_LIVE_SESSION_DRILL_ROUTE.md` and `docs/TITAN_ROUTE_ECOLOGY_PLAYBOOK.md`
