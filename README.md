...
- live authored examples: [playbooks/self-agent-checkpoint-rollout/PLAYBOOK.md](playbooks/self-agent-checkpoint-rollout/PLAYBOOK.md), [playbooks/witness-to-compost-pilot/PLAYBOOK.md](playbooks/witness-to-compost-pilot/PLAYBOOK.md), [playbooks/session-growth-cycle/PLAYBOOK.md](playbooks/session-growth-cycle/PLAYBOOK.md), [playbooks/owner-followthrough-campaign/PLAYBOOK.md](playbooks/owner-followthrough-campaign/PLAYBOOK.md), [AOA-P-0027 reviewed-automation-followthrough](playbooks/reviewed-automation-followthrough/PLAYBOOK.md), and [AOA-P-0028 trusted-rollout-operations](playbooks/trusted-rollout-operations/PLAYBOOK.md) inside the wider `playbooks/*/PLAYBOOK.md` family
...
- shared-root rollout operations route and companion lane: `playbooks/trusted-rollout-operations/PLAYBOOK.md`, `docs/CODEX_PLANE_ROLLOUT_CYCLE.md`, and `examples/codex_plane_rollout_lane.example.json`
