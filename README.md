...
- runtime-neutral control-plane compiler input: `generated/playbook_plan_contours.min.json` and [plan-contour contract](mechanics/scenario-composition/parts/plan-contours/docs/playbook-plan-contour-contract.md); this is an abstract owner projection, not a runnable packet
...
- the runtime-neutral plan-contour ABI at `generated/playbook_plan_contours.min.json`, derived for three explicitly admitted compiler scenarios
