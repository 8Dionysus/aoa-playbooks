...
- shared-root deployment continuity companion: [docs/CODEX_PLANE_ROLLOUT_CYCLE](docs/CODEX_PLANE_ROLLOUT_CYCLE.md) and [examples/codex_plane_rollout_lane.example.json](examples/codex_plane_rollout_lane.example.json)
...
- live authored examples: [playbooks/self-agent-checkpoint-rollout/PLAYBOOK.md](playbooks/self-agent-checkpoint-rollout/PLAYBOOK.md), [playbooks/witness-to-compost-pilot/PLAYBOOK.md](playbooks/witness-to-compost-pilot/PLAYBOOK.md), [playbooks/session-growth-cycle/PLAYBOOK.md](playbooks/session-growth-cycle/PLAYBOOK.md), [playbooks/owner-followthrough-campaign/PLAYBOOK.md](playbooks/owner-followthrough-campaign/PLAYBOOK.md), and [AOA-P-0027 reviewed-automation-followthrough](playbooks/reviewed-automation-followthrough/PLAYBOOK.md) inside the wider `playbooks/*/PLAYBOOK.md` family
...
- shared-root deployment continuity companion: `docs/CODEX_PLANE_ROLLOUT_CYCLE.md` and `examples/codex_plane_rollout_lane.example.json`
