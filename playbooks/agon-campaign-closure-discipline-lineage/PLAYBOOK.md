---
id: AOA-P-0044
name: agon-campaign-closure-discipline-lineage
status: experimental
summary: Repeated closure-denial and closure-candidate trials across time.
scenario: agon_campaign_closure_discipline_lineage
...
# agon-campaign-closure-discipline-lineage

## Intent

Repeated closure-denial and closure-candidate trials across time. The route keeps the campaign as reviewed choreography only: it can collect candidate episodes, lineage hints, and owner handoff records, but it cannot open a live arena or decide canon.
