---
id: AOA-P-0042
name: agon-campaign-prediction-rivalry
status: experimental
summary: Repeated model-of-other prediction contests between actors or schools.
scenario: agon_campaign_prediction_rivalry
...
# agon-campaign-prediction-rivalry

## Intent

Repeated model-of-other prediction contests between actors or schools. The route keeps the campaign as reviewed choreography only: it can collect candidate episodes, lineage hints, and owner handoff records, but it cannot open a live arena or decide canon.
