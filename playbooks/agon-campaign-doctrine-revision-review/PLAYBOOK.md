---
id: AOA-P-0043
name: agon-campaign-doctrine-revision-review
status: experimental
summary: Bounded review of doctrine evolution pressure without automatic rewrite.
scenario: agon_campaign_doctrine_revision_review
...
# agon-campaign-doctrine-revision-review

## Intent

Bounded review of doctrine evolution pressure without automatic rewrite. The route keeps the campaign as reviewed choreography only: it can collect candidate episodes, lineage hints, and owner handoff records, but it cannot open a live arena or decide canon.
