---
id: AOA-P-0040
name: agon-campaign-false-consensus-resistance
status: experimental
summary: Repeated trials that test whether consensus emerged from pressure or convenience.
scenario: agon_campaign_false_consensus_resistance
...
# agon-campaign-false-consensus-resistance

## Intent

Repeated trials that test whether consensus emerged from pressure or convenience. The route keeps the campaign as reviewed choreography only: it can collect candidate episodes, lineage hints, and owner handoff records, but it cannot open a live arena or decide canon.
