...
If a real run suggests a new handoff bridge, subagent split, automation seed, or failure/follow-up mapping, that suggestion must still clear [playbook composition gates](../../../../scenario-composition/parts/composition-surfaces/docs/playbook-composition-gates.md) before it can enter composition-owned surfaces.
