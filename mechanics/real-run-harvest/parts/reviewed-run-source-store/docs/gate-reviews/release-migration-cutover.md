...
- Verdict surface: `mechanics/real-run-harvest/parts/reviewed-run-source-store/docs/gate-reviews/release-migration-cutover.md`
...
- The first real cutover run should be summarized at `mechanics/real-run-harvest/parts/reviewed-run-source-store/docs/real-runs/YYYY-MM-DD.release-migration-cutover.md`.
