...
- Verdict surface: `mechanics/real-run-harvest/parts/reviewed-run-source-store/docs/gate-reviews/incident-recovery-routing.md`
...
- Only a live incident should open the first reviewed summary at `mechanics/real-run-harvest/parts/reviewed-run-source-store/docs/real-runs/YYYY-MM-DD.incident-recovery-routing.md`.
