...
- `mechanics/real-run-harvest/parts/harvest-template-source-store/examples/alpha_harvests/restartable-inquiry-loop.harvest-template.md`
- `mechanics/real-run-harvest/parts/phase-alpha-evidence-store/docs/alpha-reviewed-runs/2026-04-02.restartable-inquiry-loop.md`
