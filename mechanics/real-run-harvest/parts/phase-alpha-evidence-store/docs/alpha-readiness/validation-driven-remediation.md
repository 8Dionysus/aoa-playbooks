...
- `mechanics/real-run-harvest/parts/harvest-template-source-store/examples/alpha_harvests/validation-driven-remediation.harvest-template.md`
- `mechanics/real-run-harvest/parts/phase-alpha-evidence-store/docs/alpha-reviewed-runs/2026-04-02.validation-driven-remediation.md`
- `mechanics/real-run-harvest/parts/phase-alpha-evidence-store/docs/alpha-reviewed-runs/2026-04-02.validation-driven-remediation-recall-rerun.md`
