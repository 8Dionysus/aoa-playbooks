...
- `mechanics/real-run-harvest/parts/harvest-template-source-store/examples/alpha_harvests/self-agent-checkpoint-rollout.harvest-template.md`
- `mechanics/real-run-harvest/parts/phase-alpha-evidence-store/docs/alpha-reviewed-runs/2026-04-02.self-agent-checkpoint-rollout.md`
