...
| --- | --- | --- | --- | --- |
| `trial-playbooks` | Wave VI pre-protocol trial playbook doctrine, seed, schema, examples, builder, and validator | `parts/trial-playbooks/**`, root `playbooks/agon-*-trial/PLAYBOOK.md`, `generated/agon_trial_playbook_registry.min.json` | `python mechanics/agon/parts/trial-playbooks/scripts/build_agon_trial_playbook_registry.py --check`, `python mechanics/agon/parts/trial-playbooks/scripts/validate_agon_trial_playbooks.py` | active |
...
| `campaign-playbooks` | Wave XVI campaign playbook candidate registry | `parts/campaign-playbooks/**`, root campaign playbooks, `generated/agon_campaign_playbook_registry.min.json` | builder `--check` plus campaign validator | active |
...
- `playbooks/agon-*/PLAYBOOK.md` stay in `playbooks/` as source playbook
  canon.
