...
SRC = PART_ROOT / 'config/agon_campaign_playbooks.seed.json'
OUT = ROOT / 'generated/agon_campaign_playbook_registry.min.json'
ENTRY_SCHEMA = PART_ROOT / 'schemas' / 'agon-campaign-playbook.schema.json'
REGISTRY_SCHEMA = PART_ROOT / 'schemas' / 'agon-campaign-playbook-registry.schema.json'
BUILDER = ROOT / 'scripts' / 'build_agon_campaign_playbook_registry.py'
ITEM_KEY = 'campaign_playbooks'
EXPECTED_COUNT = 6
