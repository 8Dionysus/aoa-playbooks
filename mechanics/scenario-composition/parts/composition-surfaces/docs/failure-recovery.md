...
`generated/playbook_failure_catalog.json` is derived from `mechanics/scenario-composition/parts/composition-surfaces/config/playbook_composition_overrides.json`.
