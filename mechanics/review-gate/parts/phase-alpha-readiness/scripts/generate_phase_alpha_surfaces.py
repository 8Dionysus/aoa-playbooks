...
def _load_config() -> dict[str, object]:
    ...
    if not isinstance(payload, dict):
        raise SystemExit("[error] mechanics/real-run-harvest/parts/phase-alpha-evidence-store/config/phase_alpha_curated_core.json must contain an object")
    return payload
...
def build_phase_alpha_review_packets_payload() -> dict[str, object]:
    ...
    return {
        ...
        "phase": "alpha",
        "source_of_truth": {
            "phase_alpha_config": "mechanics/real-run-harvest/parts/phase-alpha-evidence-store/config/phase_alpha_curated_core.json",
            "alpha_harvests_dir": "mechanics/real-run-harvest/parts/harvest-template-source-store/examples/alpha_harvests",
            "alpha_reviewed_runs_dir": "mechanics/real-run-harvest/parts/phase-alpha-evidence-store/docs/alpha-reviewed-runs",
            "alpha_readiness_dir": "mechanics/real-run-harvest/parts/phase-alpha-evidence-store/docs/alpha-readiness",
        },
        "playbooks": entries,
    }
    ...
    if args.check:
        ...
        if current_review_packets != review_packets:
            raise SystemExit(
                ...
                "run mechanics/review-gate/parts/phase-alpha-readiness/scripts/generate_phase_alpha_surfaces.py"
            )
