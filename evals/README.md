...
This skeleton `evals/` port preserves playbook-born eval pressure such as
scenario composition cases, fallback and handoff cues, evidence posture
fixtures, and real-run harvest questions.
