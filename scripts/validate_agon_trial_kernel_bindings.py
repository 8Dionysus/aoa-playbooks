...
ITEM_KEY = 'bindings'
REQUIRED_FIELDS = ['binding_id', 'trial_id', 'playbook_id', 'kernel_model_id', 'runtime_kernel_id', 'allowed_lawful_moves', 'required_packets']
...
def expected_registry(data, items):
    return {
        'registry_id': data.get('registry_id', 'agon.trial_kernel_binding.registry.v0'),
