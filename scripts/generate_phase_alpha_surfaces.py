#!/usr/bin/env python3
"""Compatibility command for the review-gate Phase Alpha builder."""
...
SPEC = importlib.util.spec_from_file_location("review_gate_phase_alpha_builder", IMPL_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError(f"unable to load review-gate Phase Alpha builder from {IMPL_PATH}")
