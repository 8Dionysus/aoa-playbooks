#!/usr/bin/env python3
"""Compatibility command for the Agon trial-kernel binding registry builder."""
...
IMPL_PATH = (
    ...
    / "scripts"
    / "build_agon_trial_kernel_binding_registry.py"
)

SPEC = importlib.util.spec_from_file_location("agon_trial_kernel_binding_registry_builder", IMPL_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError(f"unable to load Agon trial-kernel binding builder from {IMPL_PATH}")
