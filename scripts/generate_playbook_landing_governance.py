#!/usr/bin/env python3
"""Compatibility command for the review-gate landing-governance builder."""
...
SPEC = importlib.util.spec_from_file_location("review_gate_landing_governance_builder", IMPL_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError(f"unable to load review-gate landing-governance builder from {IMPL_PATH}")
