#!/usr/bin/env python3
"""Compatibility command for the Agon campaign-playbook registry builder."""
...
IMPL_PATH = (
    ...
    / "campaign-playbooks"
    / "scripts"
    / "build_agon_campaign_playbook_registry.py"
)

SPEC = importlib.util.spec_from_file_location("agon_campaign_playbook_registry_builder", IMPL_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError(f"unable to load Agon campaign-playbook builder from {IMPL_PATH}")
