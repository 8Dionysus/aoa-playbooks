#!/usr/bin/env python3
"""Compatibility command for the Agon trial-playbook registry builder."""
...
IMPL_PATH = (
    ...
    / "trial-playbooks"
    / "scripts"
    / "build_agon_trial_playbook_registry.py"
)

SPEC = importlib.util.spec_from_file_location("agon_trial_playbook_registry_builder", IMPL_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError(f"unable to load Agon trial-playbook builder from {IMPL_PATH}")
