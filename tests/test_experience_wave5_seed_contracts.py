...
WAVE5_CONTRACTS = (
    ('first_release_runbook_record_v1', 'first_release_runbook_record_v1.json'),
    ('handoff_drill_runbook_v1', 'handoff_drill_runbook_v1.json'),
    ('installation_runbook_record_v1', 'installation_runbook_record_v1.json'),
    ('multi_office_release_train_runbook_v1', 'multi_office_release_train_runbook_v1.json'),
    ('office_bootstrap_runbook_step_v1', 'office_bootstrap_runbook_step_v1.json'),
    ('operator_console_playbook_step_v1', 'operator_console_playbook_step_v1.json'),
