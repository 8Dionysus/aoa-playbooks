...
def build_receipt(event_kind: str = "playbook_review_harvest_receipt") -> dict:
    return {
        ...
        "evidence_refs": [
            {
                "kind": "reviewed_run",
                "ref": "repo:aoa-playbooks/mechanics/real-run-harvest/parts/reviewed-run-source-store/docs/real-runs/2026-04-07.owner-first-capability-landing.md",
            }
        ],
        "payload": {
            "gate_verdict": "composition-landed",
            "reviewed_run_ref": "mechanics/real-run-harvest/parts/reviewed-run-source-store/docs/real-runs/2026-04-07.owner-first-capability-landing.md",
        },
    }


class PlaybookPublishLiveReceiptsTests(unittest.TestCase):
