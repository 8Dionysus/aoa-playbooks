...
WAVE4_CONTRACTS = (
    ('appeal_playbook_run', 'appeal_playbook_run_v1.json'),
    ('governance_playbook_run', 'governance_playbook_run_v1.json'),
    ('retirement_playbook_run', 'retirement_playbook_run_v1.json'),
    ('veto_playbook_run', 'veto_playbook_run_v1.json'),
    ('constitution_runtime_run_v1', 'constitution_runtime_run_v1.json'),
)
CONTRACT_PACKAGE_ROOTS = {
    'appeal_playbook_run': ROOT / "mechanics/release-support/parts/promotion-and-retention",
    'governance_playbook_run': ROOT / "mechanics/experience/parts/certification-and-governance",
    'retirement_playbook_run': ROOT / "mechanics/release-support/parts/promotion-and-retention",
    'veto_playbook_run': ROOT / "mechanics/release-support/parts/rollback-and-regression",
    'constitution_runtime_run_v1': ROOT / "mechanics/experience/parts/service-and-office",
}
