...
WAVE3_STEMS = (
    "adoption_playbook_run",
    "adoption_retention_playbook_run",
    "adoption_rollback_playbook_run",
    "agonic_trial_adoption_run",
    "assistant_adoption_certification_run",
    "federation_harvest_run",
    "kag_dossier_run",
    "owner_adoption_quest_run",
    "owner_adoption_quest_template",
    "pattern_merge_split_run",
    "playbook_pattern_adoption_patch",
    "shadow_adoption_playbook_run",
