...
class DecisionIndexTests(unittest.TestCase):
    ...
    def test_canonical_filename_must_match_decision_id(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            source_path = (
                ...
                / "docs"
                / "decisions"
                / "AOA-PB-D-0014-collapse-mechanics-root-entrypoints.md"
            )
            wrong_path = (
                temp_root
                / "docs"
                / "decisions"
                / "AOA-PB-D-9999-collapse-mechanics-root-entrypoints.md"
            )
        ...
        self.assertIn(
            (
                "docs/decisions/AOA-PB-D-9999-collapse-mechanics-root-entrypoints.md",
    ...
    def test_generated_index_contract_names_expected_outputs(self) -> None:
        ...
        self.assertEqual(
            "aoa_playbooks_decision_index_contract_v1",
    ...
    def test_generate_check_uses_full_contract_validation(self) -> None:
        ...
        self.assertIn(
            "source_records must be docs/decisions/AOA-PB-D-*.md",
            stdout.getvalue(),
        )
