        ...
        write_text(
            ...
            "\n".join(
                (
                    ...
                    "",
                    "## Frontier",
                    "- `AOA-PB-Q-0001` Publish the recurrence and reanchor doctrine.",
                    "",
                    "## Near",
                    "- `AOA-PB-Q-0002` Define harvest thresholds and promotion destinations.",
                    "",
            ...
            write_text(
                ...
                "\n".join(
                    (
                        ...
                        "state: ready" if quest_id == "AOA-PB-Q-0001" else "state: triaged",
