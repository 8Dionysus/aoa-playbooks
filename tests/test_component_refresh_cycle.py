...
def test_component_refresh_cycle_docs_stay_discoverable() -> None:
...
def test_component_refresh_cycle_stays_out_of_composition_until_reviewed_run() -> None:
    ...
    assert landing_by_id["AOA-P-0030"]["in_composition_manifest"] is False
    assert landing_by_id["AOA-P-0030"]["gate_verdict"] is None
    assert "component-refresh-cycle" not in manifest["managed_playbooks"]
