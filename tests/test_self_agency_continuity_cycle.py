...
def test_self_agency_continuity_cycle_stays_out_of_composition_until_gate_review() -> None:
    ...
    assert landing_by_id["AOA-P-0029"]["in_composition_manifest"] is False
    assert landing_by_id["AOA-P-0029"]["gate_verdict"] is None
    assert "self-agency-continuity-cycle" not in manifest["managed_playbooks"]
