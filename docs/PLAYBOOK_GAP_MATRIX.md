...
The main move is:
- use [PLAYBOOK_OPERATIONAL_FAMILY](PLAYBOOK_OPERATIONAL_FAMILY.md) to keep the operational family differentiated, including the `AOA-P-0026` and `AOA-P-0027` boundaries inside the broader growth-refinery family, the extracted `AOA-P-0028` rollout-operations branch, the `AOA-P-0029` anchor-bound continuity route, and the new `AOA-P-0030` owner-law component refresh route, before adding more scenario classes
