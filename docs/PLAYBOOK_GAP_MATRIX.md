...
For this wave, the main portfolio advance is one boundary-fixing extraction plus consolidation rather than another burst of overlapping playbooks.

The main move is:
- use [PLAYBOOK_OPERATIONAL_FAMILY](PLAYBOOK_OPERATIONAL_FAMILY.md) to keep the operational family differentiated, including the `AOA-P-0026` and `AOA-P-0027` boundaries inside the broader growth-refinery family and the extracted `AOA-P-0028` rollout-operations branch, before adding more scenario classes
