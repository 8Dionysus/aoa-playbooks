...
- use [PLAYBOOK_COMPOSITION_GATES](PLAYBOOK_COMPOSITION_GATES.md) and the per-playbook gate-review surfaces under `docs/gate-reviews/` to decide whether `AOA-P-0017`, `AOA-P-0018`, `AOA-P-0019`, or `AOA-P-0020` honestly deserve composition
