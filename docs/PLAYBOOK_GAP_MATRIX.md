...
The main move is:
- use [PLAYBOOK_OPERATIONAL_FAMILY](PLAYBOOK_OPERATIONAL_FAMILY.md) to keep the operational family differentiated, including the new `AOA-P-0026` boundary between closeout continuity and full session growth, before adding more scenario classes
...
Beyond `AOA-P-0026`, no new playbook should enter the portfolio just to fill space while these chooser, harvest, and gate surfaces are still the next honest move.
