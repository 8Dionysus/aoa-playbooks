...
- Read [PLAYBOOK_STRESS_CHAOS_WAVE1](PLAYBOOK_STRESS_CHAOS_WAVE1.md) for the bounded runtime-chaos degraded-lane and re-entry landing.
- Read [AGON_TRIAL_PLAYBOOKS](AGON_TRIAL_PLAYBOOKS.md), [AGON_MECHANICAL_TRIAL_MODEL](AGON_MECHANICAL_TRIAL_MODEL.md), [AGON_TRIAL_CHOREOGRAPHY_BOUNDARY](AGON_TRIAL_CHOREOGRAPHY_BOUNDARY.md), [AGON_TRIAL_ASSISTANT_SERVICE_BOUNDARY](AGON_TRIAL_ASSISTANT_SERVICE_BOUNDARY.md), [AGON_TRIAL_OWNER_HANDOFFS](AGON_TRIAL_OWNER_HANDOFFS.md), and [AGON_WAVE6_PLAYBOOK_LANDING](AGON_WAVE6_PLAYBOOK_LANDING.md) for the Wave VI pre-protocol Agon trial family.
...
- [CODEX_PLANE_ROLLOUT_CYCLE](CODEX_PLANE_ROLLOUT_CYCLE.md) - how the shared-root Codex-plane deployment continuity lane stays a companion route under `AOA-P-0028`
- [TRUSTED_ROLLOUT_CAMPAIGN_CADENCE](TRUSTED_ROLLOUT_CAMPAIGN_CADENCE.md) - how grouped rollout campaign cadence stays an adjunct under `AOA-P-0028` instead of a new sovereign playbook
...
- [PLAYBOOK_STRESS_CHAOS_WAVE1](PLAYBOOK_STRESS_CHAOS_WAVE1.md) - how the runtime-chaos degraded-lane wave lands bounded stress lanes and gates without absorbing runtime, KAG, or eval ownership
- [AGON_TRIAL_PLAYBOOKS](AGON_TRIAL_PLAYBOOKS.md) - how the Wave VI Agon trial family stays playbook-owned, recurring, and pre-protocol
- [AGON_MECHANICAL_TRIAL_MODEL](AGON_MECHANICAL_TRIAL_MODEL.md) - how mechanical trial rehearsal differs from live arena protocol
- [AGON_TRIAL_CHOREOGRAPHY_BOUNDARY](AGON_TRIAL_CHOREOGRAPHY_BOUNDARY.md) - how trial choreography stays below arena sovereignty
- [AGON_TRIAL_ASSISTANT_SERVICE_BOUNDARY](AGON_TRIAL_ASSISTANT_SERVICE_BOUNDARY.md) - how assistants may support trials without becoming hidden contestants
- [AGON_TRIAL_OWNER_HANDOFFS](AGON_TRIAL_OWNER_HANDOFFS.md) - how future eval, memo, routing, stats, skill, and technique handoffs stay explicit
- [AGON_WAVE6_PLAYBOOK_LANDING](AGON_WAVE6_PLAYBOOK_LANDING.md) - the bounded Wave VI landing order and verify path
