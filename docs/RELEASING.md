...
`aoa-playbooks` is released as a repository of scenario-level doctrine, authored playbook bundles, reviewed evidence notes, checked mechanics packages, and derived activation/federation/review-status/composition surfaces.
