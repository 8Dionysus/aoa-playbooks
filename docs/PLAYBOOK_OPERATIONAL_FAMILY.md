...
| `AOA-P-0029 self-agency-continuity-cycle` | reviewed anchor already needs bounded continuity across more than one revision window | preserve continuity across reviewed anchors, bounded reflective revision, explicit reanchor, and bounded relaunch aids | reviewed anchor plus agent, memo, stats, and eval surfaces that remain subordinate to the anchor | `review_required` with anchor-trace return | continued continuity, reanchored continuity, defer, or safe stop | `AOA-P-0023`, `AOA-P-0025`, `AOA-P-0028` | `AOA-P-0025`, `AOA-P-0018`, or later reviewed continuity proof |
| `AOA-P-0030 component-refresh-cycle` | reviewed internal component drift already has one named owner law and one bounded refresh target | one owner-law refresh route through decision, owner validation, derived summary refresh, and optional memo writeback | one owner repo plus weaker sdk carry, derived stats, and optional memo follow-through | `review_required` with component-anchor return | `refresh_complete`, `rollback_complete`, `refresh_deferred`, or `safe_stop` | `AOA-P-0018`, `AOA-P-0025`, `AOA-P-0028` | `AOA-P-0018`, `AOA-P-0028`, or later owner-local hardening |
| `AOA-P-0031 a2a-summon-return-checkpoint` | reviewed summon child route already has a parent anchor, SDK A2A decision, child result, and checkpoint bridge need | one reviewed child-return route through SDK decision, Codex-local target, checkpoint bridge, proof hook, memo writeback, and runtime dry-run receipt | parent route plus `aoa-skills`, `aoa-sdk`, `aoa-agents`, `aoa-evals`, `aoa-memo`, `aoa-routing`, and `abyss-stack` surfaces that stay owner-owned | `review_required` with checkpoint-anchor return | `return_ready`, `split_required`, `human_gate_required`, or `safe_stop` | `AOA-P-0025`, `AOA-P-0027`, `AOA-P-0030` | `AOA-P-0025`, `AOA-P-0018`, or later SDK/runtime dry-run hardening |
...
- `AOA-P-0029` = long-arc continuity across reviewed anchors, bounded revision windows, explicit reanchor, and bounded relaunch aids
...
- `AOA-P-0031` = reviewed A2A summon child-return route across SDK decision, Codex-local target, checkpoint bridge, proof, memo writeback, and runtime dry-run receipt
